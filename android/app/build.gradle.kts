...
android {
    ...
    defaultConfig {
        applicationId = "com.loansathi.app"
    ...
    buildTypes {
        release {
            ...
            // R8 is enabled by default and handles code shrinking
            // ProGuard rules for additional optimizations
            proguardFiles(
