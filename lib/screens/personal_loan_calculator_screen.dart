...
class PersonalLoanCalculatorScreen extends StatefulWidget {
  ...
  @override
  State<PersonalLoanCalculatorScreen> createState() => _PersonalLoanCalculatorScreenState();
}

class _PersonalLoanCalculatorScreenState extends State<PersonalLoanCalculatorScreen> {
...
class _CustomSliderThumb extends SliderComponentShape {
  ...
  void paint(
    ...
    // Draw white circle with purple border
    final paint = Paint()
      ..color = Colors.white
